...
while waiting_input:
    ...
    if user_choice == '1':
        ...
        if len(blockchain) >= 1:
            blockchain[0] = {'previous_hash': '',
                             'index': 0,
                             'transactions': [{'sender': 'Chris', 'recipient': 'Douglas', 'amount': 100.0}]}
    elif user_choice == 'q':
        waiting_input = False
    else:
    ...
    if not verify_chain():
        ...
        break
    print('Balance of {}: {:6.2f}'.format('Douglas', get_balance('Douglas')))
else:
    print('User Left!')
print('Done!')
